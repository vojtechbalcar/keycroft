...
const MEADOW_BUILDINGS: BuildingDefinition[] = [
  ...
  },
  {
    ...
    name: 'Barn',
    emoji: '🐄',
    description: 'Home to the village livestock. Boosts your accuracy recovery.',
    hotspot: { x: 72, y: 68 },
    labelPosition: { x: 72, y: 68 },
    levels: buildLevels([
      'No bonus yet',
      '+2% accuracy floor',
      '+4% accuracy floor',
